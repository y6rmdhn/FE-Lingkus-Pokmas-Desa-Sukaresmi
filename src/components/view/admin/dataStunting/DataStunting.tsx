...
const StuntingPage = () => {
  return (
    <AdminLayout>
      <h1 className="text-3xl font-bold text-[#0F828C] mb-8">DATA STUNTING</h1>
        ...
        <Table>
          ...
          <TableHeader className="bg-blue-900">
            <TableRow>
              ...
              <TableHead className="text-white font-bold">Tahun</TableHead>
              <TableHead className="text-white font-bold">Bulan</TableHead>
